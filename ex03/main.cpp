...
int main(int argc, char **argv)
{
    ...
    cout << "\nbuild models" << endl;
    cout << "pt" << endl;
    pt.build("files/ref.pt");
    cout << "en" << endl;
    en.build("files/ref.en");
    cout << "fr" << endl;
    fr.build("files/ref.fr");
    cout << "bg" << endl;
    bg.build("files/ref.bg");
    cout << "cs" << endl;
    cs.build("files/ref.cs");
    cout << "de" << endl;
    de.build("files/ref.de");
    cout << "es" << endl;
    es.build("files/ref.es");
    cout << "et" << endl;
    et.build("files/ref.et");
    cout << "it" << endl;
    it.build("files/ref.it");
    cout << "nl" << endl;
    nl.build("files/ref.nl");
    cout << "pl" << endl;
    pl.build("files/ref.pl");
    cout << "ro" << endl;
    ro.build("files/ref.ro");
    cout << "da" << endl;
    da.build("files/ref.da");
    cout << "el" << endl;
    el.build("files/ref.el");
    cout << "fi" << endl;
    fi.build("files/ref.fi");
    cout << "hu" << endl;
    hu.build("files/ref.hu");
    cout << "sv" << endl;
    sv.build("files/ref.sv");
    cout << "lv" << endl;
    lv.build("files/ref.lv");
    cout << "sk" << endl;
    sk.build("files/ref.sk");
    cout << "sl" << endl;
    sl.build("files/ref.sl");
